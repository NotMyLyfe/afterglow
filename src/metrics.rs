...
pub static READS: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!("afterglow_reads_total", "Total number of reads", &["route"])
        .expect("Failed to create afterglow_reads_total metric")
});

#[allow(clippy::expect_used)]
pub static WRITES: LazyLock<IntCounter> = LazyLock::new(|| {
    register_int_counter!("afterglow_writes_total", "Total number of writes")
        .expect("Failed to create afterglow_writes_total metric")
});
...
pub static GET_TOKEN: LazyLock<IntCounter> = LazyLock::new(|| {
    ...
    .expect("Failed to create afterglow_get_token_total metric")
});
...
pub static SET_TOKEN: LazyLock<IntCounter> = LazyLock::new(|| {
    ...
    .expect("Failed to create afterglow_set_token_total metric")
});
